...
export const _userPlans = [
  {
    ...
    price: 9.99,
    primary: false,
    description: ['1000 free mails monthly', 'For startups and small teams'],
  },
  {
    id: 2,
    ...
    price: 39.99,
    primary: false,
    description: ['5000 free mails monthly', 'For medium sized teams'],
  },
  {
    id: 3,
    ...
    price: 69.99,
    primary: true,
    description: ['10000 free mails monthly', 'Promoted mailing services', 'For larger teams'],
  },
];
